...
class CouponRedeemAdapterexp(val context: Context, val itemList: MutableList<Int>, val coupon_image: String,
    ...
    override fun onBindViewHolder(holder: CouponRedeemViewHolder, position: Int) {
        holder.llCouponRedeem.setOnClickListener { v: View ->
            showDialog("Your Coupon Got Expired", position)
        }
...
//                .into(holder.ivCouponRedeemImage)
    ...
    private fun showDialog(title: String, position: Int) {
        ...
        dialogs.setContentView(R.layout.popup_coupon_redeem_view_exp)
        dialogs.show()
