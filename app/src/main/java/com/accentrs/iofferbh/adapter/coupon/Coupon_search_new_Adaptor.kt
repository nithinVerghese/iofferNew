...
import com.accentrs.iofferbh.model.coupon.Couponsearch
...
class Coupon_search_new_Adaptor(val context: Context, val couponStoreItemList: List<Couponsearch>?) : RecyclerView.Adapter<CouponStoreViewHolder>() {
