...
public class OfferDeliveryWhatsappAdaptor extends RecyclerView.Adapter<OfferDeliveryWhatsappAdaptor.mainViewHolder> {
    ...
    public OfferDeliveryWhatsappAdaptor(Context context, List<WhatsappDataAdaptor> modelList, String shareUrl) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.modelList = (ArrayList<WhatsappDataAdaptor>) modelList;
        this.imageURL = shareUrl;
    }
