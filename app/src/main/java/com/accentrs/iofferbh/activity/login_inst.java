...
public class login_inst extends AppCompatActivity implements AuthenticationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appPreferences = new AppPreferences(login_inst.this);
    ...
    public void onClick(View view) {
        if(token!=null)
        {
            ...
            authenticationDialog = new AuthenticationDialog(login_inst.this, login_inst.this);
