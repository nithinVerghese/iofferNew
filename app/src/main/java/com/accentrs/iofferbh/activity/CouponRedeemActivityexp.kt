...
import com.accentrs.iofferbh.adapter.coupon.CouponRedeemAdapterexp
import com.accentrs.iofferbh.interfaces.OnItemClick
import kotlinx.android.synthetic.main.activity_coupon_redeem.*

class CouponRedeemActivityexp : BaseActivity(), OnItemClick {
    ...
    private fun setAdapter() {
        ...
        rv_coupon_redeem.layoutManager = GridLayoutManager(this@CouponRedeemActivityexp, 1)
        rv_coupon_redeem.adapter = CouponRedeemAdapterexp(this@CouponRedeemActivityexp, list, coupon_image, s_id, coupon_name, this)
    }
