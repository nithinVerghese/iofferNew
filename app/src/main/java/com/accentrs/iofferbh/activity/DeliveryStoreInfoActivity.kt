...
class DeliveryStoreInfoActivity : BaseActivity() {
    ...
    private fun fetchIntent() {
        ...
        sName = intent.getStringExtra("s_name")
        sImg = intent.getStringExtra("s_img")
    }

    private fun hitApi() {
        showProgressDialog(getString(com.accentrs.iofferbh.R.string.msg_loading))
        val call = apiIneterfaceDe.dshopinfo(sId)
    ...
    private fun setView() {
        ...
        GlideApp.with(this@DeliveryStoreInfoActivity)
                .load(sLogo)
