...
class paymentshare : BaseActivity() {
...
//        builder.setPositiveButton("Debit") { delivery_indo_dialog, which ->
            var strUser = SharedPreferencesData(this@paymentshare).get_D_PAY()
...
//                button_forward.isEnabled = web_view.canGoForward()
            ...
            override fun onPageFinished(view: WebView, url: String) {
                ...
                if(fin.contains("Problem")){
                    ...
                    SharedPreferencesData(this@paymentshare).putcart(false)
                    val intent = Intent(this@paymentshare, HomeScreenActivity::class.java);
                ...
                if((fin.contains("CAPTURED"))||(fin.contains("captured"))){
                    ...
                    val intent = Intent(this@paymentshare, MyCouponActivity::class.java);
                    startActivity(intent)
                    finish()
        ...
        call.enqueue(object : Callback<CouponPurchaseResponse> {
            ...
            override fun onResponse(call: Call<CouponPurchaseResponse>, response: Response<CouponPurchaseResponse>) {
                ...
                if (response.isSuccessful && response.body()?.status == true) {
                    ...
                    val intent = Intent(this@paymentshare, HomeScreenActivity::class.java)  //back to home
